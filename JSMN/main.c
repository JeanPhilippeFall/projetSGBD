// pour faire le test pour le moment, inclure un fichier test.json dans le mm dossier contenant le code source
...
#define JSON_FILE_PATH "test.json" // le path va changer et sera récupéré au niveau de la commande XJ_convertor
